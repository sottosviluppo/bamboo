...
class Version20160131002537 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');

        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, recipient_name VARCHAR(255) DEFAULT NULL, recipient_surname VARCHAR(255) DEFAULT NULL, city VARCHAR(64) NOT NULL, country_id INT NOT NULL, postal_code VARCHAR(64) NOT NULL, address VARCHAR(255) NOT NULL, address_more VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) NOT NULL, mobile VARCHAR(255) DEFAULT NULL, comments LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, enabled TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE store (id INT AUTO_INCREMENT NOT NULL, logo_id INT DEFAULT NULL, secondary_logo_id INT DEFAULT NULL, mobile_logo_id INT DEFAULT NULL, header_image_id INT DEFAULT NULL, background_image_id INT DEFAULT NULL, address_id INT DEFAULT NULL, default_language_iso VARCHAR(10) DEFAULT NULL, default_tax_id INT DEFAULT NULL, default_currency_iso VARCHAR(3) DEFAULT NULL, name VARCHAR(255) NOT NULL, leitmotiv VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, is_company TINYINT(1) NOT NULL, cif VARCHAR(255) DEFAULT NULL, tracker VARCHAR(255) DEFAULT NULL, template VARCHAR(255) DEFAULT NULL, routing_strategy VARCHAR(255) NOT NULL, use_stock TINYINT(1) NOT NULL, tax_included TINYINT(1) NOT NULL, vat VARCHAR(255) DEFAULT NULL, fiscal_code VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_FF575877F98F144A (logo_id), UNIQUE INDEX UNIQ_FF5758773C91E28A (secondary_logo_id), UNIQUE INDEX UNIQ_FF5758771925D9BF (mobile_logo_id), UNIQUE INDEX UNIQ_FF5758778C782417 (header_image_id), UNIQUE INDEX UNIQ_FF575877E6DA28AA (background_image_id), INDEX IDX_FF575877F5B7AF75 (address_id), INDEX IDX_FF575877920835C7 (default_language_iso), INDEX IDX_FF575877910402F0 (default_currency_iso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, delivery_address_id INT DEFAULT NULL, invoice_address_id INT DEFAULT NULL, language_iso VARCHAR(10) DEFAULT NULL, tax_id INT DEFAULT NULL, gender INT DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, token VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, birthday DATE DEFAULT NULL, recovery_hash VARCHAR(255) DEFAULT NULL, one_time_login_hash VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, last_login_at DATETIME DEFAULT NULL, enabled TINYINT(1) NOT NULL, phone VARCHAR(15) DEFAULT NULL, identity_document VARCHAR(255) DEFAULT NULL, guest TINYINT(1) NOT NULL, company TINYINT(1) NOT NULL, company_name VARCHAR(255) DEFAULT NULL, vat VARCHAR(255) DEFAULT NULL, fiscal_code VARCHAR(255) DEFAULT NULL, newsletter TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_81398E095F37A13B (token), UNIQUE INDEX UNIQ_81398E098A2057A4 (recovery_hash), UNIQUE INDEX UNIQ_81398E098586CD6F (one_time_login_hash), UNIQUE INDEX UNIQ_81398E09EBF23851 (delivery_address_id), UNIQUE INDEX UNIQ_81398E09C6BDFEB (invoice_address_id), INDEX IDX_81398E09B0DED06D (language_iso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, root TINYINT(1) NOT NULL, position INT NOT NULL, meta_title VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, css_class VARCHAR(255) DEFAULT NULL, images_sort VARCHAR(2048) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, enabled TINYINT(1) NOT NULL, INDEX IDX_64C19C1727ACA70 (parent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
